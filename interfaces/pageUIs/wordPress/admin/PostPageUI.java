...
public class PostPageUI {
	...
	public static final String SEARCH_ONLY_ONE_ROW="//a[text()='%s']//ancestor::td//following-sibling::td/a[text()='%s']//ancestor::td//following-sibling::td/a[text()='%s']//ancestor::td//following-sibling::td/a[text()='%s']";
}
