...
public class LoginPageUI {
	...
	public static final String GET_MESSAGE_INVALID_MAIL_TEXT="//label[contains(text(),'Email')]/following-sibling::span[@class='field-validation-valid']";
	public static final String MESSAGE_INVALID_MAIL_TEXT="//span[@class='field-validation-valid' and contains(text(),'%s')]";
