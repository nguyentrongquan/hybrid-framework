...
public class OrderDetailPageUI {
	...
	public static final String ORDER_TOTAL_TEXT="//li[@class='order-total']//strong[text()='%s']";
	public static final String DYNAMIC_BILLDING_ADDRESS_INFO_TEXT="//div[@class='billing-info']//li[@class='%s' and contains(string(),'%s')]";
	public static final String DYNAMIC_SHIPPING_ADDRESS_INFO_TEXT="//div[@class='shipping-info']//li[@class='%s' and contains(string(),'%s')]";
