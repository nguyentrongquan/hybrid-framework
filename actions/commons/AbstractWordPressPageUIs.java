...
public class AbstractWordPressPageUIs {
	...
	public static final String SEARCH_POST_ICON ="//a[@class='search-toggle']";
	public static final String SEARCH_POST_TEXTBOX ="//input[@placeholder='Search']";
	public static final String SEARCH_POST_BUTTON ="//button[@class='search-button']";
